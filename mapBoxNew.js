...
$("#buttonSave").click(function(){
  ...
  if ( privat == true ){
    color = '#222b30'; // ako je true stavlja se crna kao private boja..
    }
  else if ( privat == false ){
    color = '#e55e5e';
    }
  // var y = $("#privat").val(); allways returns "ON"
  var data = {
    position: latlng,
    title: title,
    ...
    placeMarker(latlng,title,description,color,icon);
    markers.push(data);
  });
